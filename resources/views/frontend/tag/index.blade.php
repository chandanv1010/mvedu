...
@section('content')
    ...
    <div class="page-breadcrumb-large" style="margin-bottom: 25px;">
        ...
        <div class="uk-container uk-container-center">
            <div class="breadcrumb-content">
                <h1 class="breadcrumb-title">Tag: {{ $tag->name }}</h1>
    ...
    <div class="panel-post-catalogue">
        <div class="uk-container uk-container-center">
            <!-- Layout 3/4 - 1/4 giống trang tin tức nổi bật -->
                                ...
                                <div class="uk-grid uk-grid-medium" data-uk-grid-match>
                                    @foreach($posts as $post)
                                        @php
                                            ...
                                            $postName = $postPivot->name ?? (isset($post->name) ? $post->name : '');
                                            $postDescription = $postPivot->description ?? (isset($post->description) ? $post->description : '');
                                            $postCanonical = $postPivot->canonical ?? (isset($post->canonical) ? $post->canonical : '');
