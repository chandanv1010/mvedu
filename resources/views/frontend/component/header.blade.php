<div id="header" class="pc-header uk-visible-large">
            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-top-right">
                    <div class="contact-info">
                        <a href="tel:{{ $system['contact_hotline'] ?? '01234567899' }}" class="phone-link">
                            <i class="fa fa-phone"></i>
                            <span>{{ $system['contact_hotline'] ?? '01234567899' }}</span>
                        </a>
                        <span class="hotline-separator">|</span>
                        <span class="hotline-label">Hotline:</span>
                        <a href="tel:{{ $system['contact_hotline'] ?? '0987654321' }}" class="hotline-link">
                            {{ $system['contact_hotline'] ?? '09.8765.4321' }}
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="header-search-form" style="display: none;">
        <div class="uk-container uk-container-center">
            <form action="{{ write_url('tim-kiem') }}" method="GET" class="search-form">
