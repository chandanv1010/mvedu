...
class CreateDistanceLearningWidget extends Command
{
    protected $signature = 'widget:create-distance-learning';
    protected $description = 'Tạo widget cho "Hệ đào tạo từ xa là gì"';
    ...
    public function handle()
    {
        ...
        try {
            ...
            if ($existingWidget && !$existingWidget->isEmpty()) {
                $this->warn('Widget "distance-learning" đã tồn tại');
            ...
            $widgetData = [
                ...
                'keyword' => 'distance-learning',
                'short_code' => 'distance-learning',
                'model' => 'PostCatalogue',
                'model_id' => $postCatalogueId,
                'description' => [
                    $languageId => 'Widget hiển thị thông tin về hệ đào tạo từ xa'
                ],
                'album' => [],
                'publish' => 2, // Active
                'note' => 'Widget cho khối "Hệ đào tạo từ xa là gì" trên homepage'
            ];
            ...
            if ($widget) {
                ...
                $this->info('  - Keyword: distance-learning');
